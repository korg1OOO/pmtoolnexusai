...
async function run() {
    ...
    try {
        ...
        -- Create Policies
        DROP POLICY IF EXISTS "Users can view milestones in their projects" ON project_milestones;
        ...
        DROP POLICY IF EXISTS "Users can insert milestones in their projects" ON project_milestones;
        ...
        DROP POLICY IF EXISTS "Users can update milestones in their projects" ON project_milestones;
        ...
        DROP POLICY IF EXISTS "Users can delete milestones in their projects" ON project_milestones;
      ...
      `);
        console.log('Successfully created project_milestones table and RLS policies.');
    } catch (e) {
        console.error(e);
    }
