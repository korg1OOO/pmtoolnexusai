-- ============================================================
-- CMS Schema + Seed Data for ProjectOye
...
-- Blog categories
('Product Updates', 'product-updates', 'blog', 'New features and improvements to ProjectOye', 1),
...
('Customer Stories', 'customer-stories', 'blog', 'Success stories from ProjectOye customers', 4),
('Engineering', 'engineering', 'blog', 'Behind the scenes at ProjectOye', 5),
-- FAQ categories
('Getting Started', 'getting-started', 'faq', 'New to ProjectOye? Start here.', 1),
...
('Integrations', 'integrations', 'faq', 'Connecting ProjectOye with your tools', 5),
-- Docs categories
('Getting Started', 'docs-getting-started', 'docs', 'Quickstart guides', 1),
('Core Concepts', 'core-concepts', 'docs', 'Understand the ProjectOye model', 2),
...
('Introducing ProjectOye: The AI-Native Project Management Platform',
 'introducing-projectoye',
 'Today we''re officially launching ProjectOye — a project management platform built from the ground up with AI at its core.',
 E'We built ProjectOye because we were tired of project management tools that felt like glorified spreadsheets. Every feature was a checkbox, every update was a manual process, and every insight required a data analyst to generate.\n\nProjectOye changes that.\n\n## What makes ProjectOye different?\n\nProjectOye is the first project management platform with a deeply integrated AI engine that can:\n\n- **Predict schedule slippage** before it happens using ML models trained on your team''s velocity\n- **Generate morning briefings** that summarize what matters most to you today\n- **Auto-assign tasks** based on team capacity, skills, and current workload\n- **Surface risk signals** from unread comments, stalled tasks, and SLA breaches\n\n## Built for enterprise teams\n\nProjectOye is designed for teams of 5 to 50,000. Our multi-tenant architecture ensures complete data isolation between organizations, with SOC 2 compliance baked in from day one.\n\n## Available today\n\nSign up at projectoye.com and start your 14-day free trial. No credit card required.',
 'published',
 ARRAY['launch', 'product', 'AI'],
 5,
 'Introducing ProjectOye: AI-Native Project Management',
 'ProjectOye is a project management platform built from the ground up with AI. Read about our launch.',
