 ...
 * Manage model retraining jobs and schedules
 */
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-green-600">{stats?.completedLast24h || 0}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-red-600">{stats?.failedLast24h || 0}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{stats?.avgDuration || 0}m</div>
                    </CardContent>
                </Card>
            </div>
