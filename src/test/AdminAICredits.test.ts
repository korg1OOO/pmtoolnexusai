/**
 * AdminAICredits Component Tests
 */
...
import { AdminAICredits } from '@/components/admin/pages/AdminAICredits';

describe('AdminAICredits', () => {
    it('exports the component', () => {
        expect(AdminAICredits).toBeDefined();
    });
});
