/**
 * AdminSecuritySettings Component Tests
 */
...
import { AdminSecuritySettings } from '@/components/admin/pages/AdminSecuritySettings';

describe('AdminSecuritySettings', () => {
    it('exports the component', () => {
        expect(AdminSecuritySettings).toBeDefined();
    });
});
