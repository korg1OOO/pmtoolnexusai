/**
 * AgentConfirmationDialog Component Tests
 */
...
import { AgentConfirmationDialog } from '@/components/ai/AgentConfirmationDialog';

describe('AgentConfirmationDialog', () => {
    it('exports the component', () => {
        expect(AgentConfirmationDialog).toBeDefined();
    });
});
