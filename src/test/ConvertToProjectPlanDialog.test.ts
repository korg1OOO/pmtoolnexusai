/**
 * ConvertToProjectPlanDialog Component Tests
 */
...
import { ConvertToProjectPlanDialog } from '@/components/notes/spreadsheet/ConvertToProjectPlanDialog';

describe('ConvertToProjectPlanDialog', () => {
    it('exports the component', () => {
        expect(ConvertToProjectPlanDialog).toBeDefined();
    });
});
