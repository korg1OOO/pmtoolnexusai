/**
 * GovernanceArtifactPanel Component Tests
 */
...
import { GovernanceArtifactPanel } from '@/components/analytics/GovernanceArtifactPanel';

describe('GovernanceArtifactPanel', () => {
    it('exports the component', () => {
        expect(GovernanceArtifactPanel).toBeDefined();
    });
});
