/**
 * LicenseAllocation Component Tests
 */
...
import { LicenseAllocation } from '@/components/tenant/LicenseAllocation';

describe('LicenseAllocation', () => {
    it('exports the component', () => {
        expect(LicenseAllocation).toBeDefined();
    });
});
