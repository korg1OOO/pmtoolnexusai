/**
 * MSProjectColumns Component Tests
 */
...
import { PredecessorColumn } from '@/components/planning/MSProjectColumns';

describe('MSProjectColumns', () => {
    it('exports the component', () => {
        expect(PredecessorColumn).toBeDefined();
    });
});
