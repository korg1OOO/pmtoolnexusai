/**
 * PortfolioDistributionDetail Component Tests
 */
...
import { PortfolioDistributionDetail } from '@/components/analytics/PortfolioDistributionDetail';

describe('PortfolioDistributionDetail', () => {
    it('exports the component', () => {
        expect(PortfolioDistributionDetail).toBeDefined();
    });
});
