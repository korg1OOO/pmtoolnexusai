/**
 * ProjectPerformanceDetail Component Tests
 */
...
import { ProjectPerformanceDetail } from '@/components/analytics/ProjectPerformanceDetail';

describe('ProjectPerformanceDetail', () => {
    it('exports the component', () => {
        expect(ProjectPerformanceDetail).toBeDefined();
    });
});
