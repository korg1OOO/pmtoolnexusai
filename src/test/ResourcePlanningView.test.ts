/**
 * ResourcePlanningView Component Tests
 */
...
import { ResourcePlanningView } from '@/components/portfolio/ResourcePlanningView';

describe('ResourcePlanningView', () => {
    it('exports the component', () => {
        expect(ResourcePlanningView).toBeDefined();
    });
});
