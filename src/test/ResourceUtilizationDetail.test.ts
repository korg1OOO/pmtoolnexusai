/**
 * ResourceUtilizationDetail Component Tests
 */
...
import { ResourceUtilizationDetail } from '@/components/analytics/ResourceUtilizationDetail';

describe('ResourceUtilizationDetail', () => {
    it('exports the component', () => {
        expect(ResourceUtilizationDetail).toBeDefined();
    });
});
