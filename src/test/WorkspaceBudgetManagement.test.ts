/**
 * WorkspaceBudgetManagement Component Tests
 */
...
import { WorkspaceBudgetManagement } from '@/components/workspace/WorkspaceBudgetManagement';

describe('WorkspaceBudgetManagement', () => {
    it('exports the component', () => {
        expect(WorkspaceBudgetManagement).toBeDefined();
    });
});
