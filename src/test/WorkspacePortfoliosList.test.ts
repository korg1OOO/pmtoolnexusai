/**
 * WorkspacePortfoliosList Component Tests
 */
...
import { WorkspacePortfoliosList } from '@/components/workspace/WorkspacePortfoliosList';

describe('WorkspacePortfoliosList', () => {
    it('exports the component', () => {
        expect(WorkspacePortfoliosList).toBeDefined();
    });
});
