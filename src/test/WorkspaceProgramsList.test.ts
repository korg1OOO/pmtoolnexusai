/**
 * WorkspaceProgramsList Component Tests
 */
...
import { WorkspaceProgramsList } from '@/components/workspace/WorkspaceProgramsList';

describe('WorkspaceProgramsList', () => {
    it('exports the component', () => {
        expect(WorkspaceProgramsList).toBeDefined();
    });
});
