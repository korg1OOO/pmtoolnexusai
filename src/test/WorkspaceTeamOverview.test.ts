/**
 * WorkspaceTeamOverview Component Tests
 */
...
import { WorkspaceTeamOverview } from '@/components/workspace/WorkspaceTeamOverview';

describe('WorkspaceTeamOverview', () => {
    it('exports the component', () => {
        expect(WorkspaceTeamOverview).toBeDefined();
    });
});
