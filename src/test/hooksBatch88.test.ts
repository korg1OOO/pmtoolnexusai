/**
 * Tests batch 88: Mass hook module loads — 15 more remaining hooks (batch 4)
 */
...
vi.mock('date-fns', () => ({ format: vi.fn(() => ''), parseISO: vi.fn(() => new Date()), differenceInDays: vi.fn(() => 0), addDays: vi.fn(() => new Date()), subDays: vi.fn(() => new Date()), isAfter: vi.fn(() => false), isBefore: vi.fn(() => false), isValid: vi.fn(() => true), startOfMonth: vi.fn(() => new Date()), endOfMonth: vi.fn(() => new Date()), eachDayOfInterval: vi.fn(() => []) }));

const hooks = [
    '@/hooks/useQualityMetrics',
    '@/hooks/useBillingHistory',
    '@/hooks/usePortfolioMetrics',
    '@/hooks/useIntegrations',
    '@/hooks/useNotificationSettings',
    '@/hooks/useWorkloadBalancing',
    '@/hooks/useCapacityPlanning',
    '@/hooks/useTimeEntries',
    '@/hooks/useComments',
    '@/hooks/useActivities',
    '@/hooks/usePresentation',
    '@/hooks/usePresentationSlides',
    '@/hooks/useColumnPreferences',
    '@/hooks/useViewPreferences',
