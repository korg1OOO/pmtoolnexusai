/**
 * useAIActionDispatcher Hook Tests
 */
...
import { dispatchAIAction } from '@/hooks/useAIActionDispatcher';

describe('useAIActionDispatcher', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(dispatchAIAction).toBeDefined();
        });
    });
