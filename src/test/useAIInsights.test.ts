...
import { useAIInsights, useInsightsByCategory, useCreateInsight, useDismissInsight, useInsightStats } from '@/hooks/useAIInsights';

describe('useAIInsights', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useAIInsights).toBeDefined();
            expect(useInsightsByCategory).toBeDefined();
            expect(useCreateInsight).toBeDefined();
            expect(useDismissInsight).toBeDefined();
            expect(useInsightStats).toBeDefined();
        });
    });
