/**
 * useAIProviderSettings Hook Tests
 */
...
describe('useAIProviderSettings', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useAIProviderSettings).toBeDefined();
            expect(useAIProviderApiKeys).toBeDefined();
            expect(useUpdateAISettings).toBeDefined();
            expect(useUpsertAPIKey).toBeDefined();
            expect(useDeleteAPIKey).toBeDefined();
        });
    });

    describe('useAIProviderSettings', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useAIProviderSettings(), { wrapper: createWrapper() });
