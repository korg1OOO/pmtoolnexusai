...
import { useAdminUsers, useAdminOrganizations, useAdminAuditLogs, useAdminApiKeys, useUpdateUserRole, useCreateOrganization, useRevokeApiKey } from '@/hooks/useAdmin';

describe('useAdmin', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useAdminUsers).toBeDefined();
            expect(useAdminOrganizations).toBeDefined();
            expect(useAdminAuditLogs).toBeDefined();
            expect(useAdminApiKeys).toBeDefined();
            expect(useUpdateUserRole).toBeDefined();
            expect(useCreateOrganization).toBeDefined();
            expect(useRevokeApiKey).toBeDefined();
        });
    });
