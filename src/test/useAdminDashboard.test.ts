...
import { useRecentActivity, useSystemStatus, useLogActivity, useUpdateServiceStatus, useActivityStats } from '@/hooks/useAdminDashboard';

describe('useAdminDashboard', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useRecentActivity).toBeDefined();
            expect(useSystemStatus).toBeDefined();
            expect(useLogActivity).toBeDefined();
            expect(useUpdateServiceStatus).toBeDefined();
            expect(useActivityStats).toBeDefined();
        });
    });
