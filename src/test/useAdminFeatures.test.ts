...
import { useAdminFeatures, useUpdateFeature, useCreateFeature, useSeedFeatures, FEATURE_CATEGORIES } from '@/hooks/useAdminFeatures';

describe('useAdminFeatures', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useAdminFeatures).toBeDefined();
            expect(useUpdateFeature).toBeDefined();
            expect(useCreateFeature).toBeDefined();
            expect(useSeedFeatures).toBeDefined();
            expect(FEATURE_CATEGORIES).toBeDefined();
        });
    });

    describe('useAdminFeatures', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useAdminFeatures(), { wrapper: createWrapper() });
