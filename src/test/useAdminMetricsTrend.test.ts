/**
 * useAdminMetricsTrend Hook Tests
 */
...
describe('useAdminMetricsTrend', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useAdminMetricsTrend).toBeDefined();
        });
    });

    describe('useAdminMetricsTrend', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useAdminMetricsTrend(), { wrapper: createWrapper() });
