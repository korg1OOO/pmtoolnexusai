/**
 * useAdminSubscriptions Hook Tests
 */
...
import { useAdminSubscriptions, useSubscriptionRevenueSummary, useOverrideSubscriptionPlan, useAdminCancelSubscription, useApplyCreditAdjustment, useToggleFeatureFlag, useSubscriptionFeatureFlags, useRefreshPricingCache } from '@/hooks/useAdminSubscriptions';

describe('useAdminSubscriptions', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useAdminSubscriptions).toBeDefined();
            expect(useSubscriptionRevenueSummary).toBeDefined();
            expect(useOverrideSubscriptionPlan).toBeDefined();
            expect(useAdminCancelSubscription).toBeDefined();
            expect(useApplyCreditAdjustment).toBeDefined();
            expect(useToggleFeatureFlag).toBeDefined();
            expect(useSubscriptionFeatureFlags).toBeDefined();
            expect(useRefreshPricingCache).toBeDefined();
        });
    });
