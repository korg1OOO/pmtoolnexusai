...
import { useProjectBaselines, useTaskBaselines, useTasksWithBaseline, useDeleteBaseline, useUpdateBaseline } from '@/hooks/useBaselines';

describe('useBaselines', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useProjectBaselines).toBeDefined();
            expect(useTaskBaselines).toBeDefined();
            expect(useTasksWithBaseline).toBeDefined();
            expect(useDeleteBaseline).toBeDefined();
            expect(useUpdateBaseline).toBeDefined();
        });
    });

    describe('useProjectBaselines', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useProjectBaselines(), { wrapper: createWrapper() });
