...
import { useChatChannels, useCreateChannel } from '@/hooks/useChatChannels';

describe('useChatChannels', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useChatChannels).toBeDefined();
            expect(useCreateChannel).toBeDefined();
        });
    });
