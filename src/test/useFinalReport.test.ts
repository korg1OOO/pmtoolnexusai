...
describe('useFinalReport', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useFinalReport).toBeDefined();
            expect(useUpdateFinalReport).toBeDefined();
        });
    });

    describe('useFinalReport', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useFinalReport(), { wrapper: createWrapper() });
