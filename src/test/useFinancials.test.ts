...
import { useFinancials, useCreateBudgetItem, useCreateInvoice } from '@/hooks/useFinancials';

describe('useFinancials', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useFinancials).toBeDefined();
            expect(useCreateBudgetItem).toBeDefined();
