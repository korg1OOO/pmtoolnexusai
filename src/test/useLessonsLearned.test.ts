...
import { useLessonsLearned, useCreateLessonLearned, useUpdateLessonLearned } from '@/hooks/useLessonsLearned';

describe('useLessonsLearned', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useLessonsLearned).toBeDefined();
            expect(useCreateLessonLearned).toBeDefined();
            expect(useUpdateLessonLearned).toBeDefined();
        });
    });

    describe('useLessonsLearned', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useLessonsLearned(), { wrapper: createWrapper() });
