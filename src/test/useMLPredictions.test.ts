...
import { useMLPredictions, useMLPrediction, useRecentMLPredictions, useExpiredPredictions, usePredictionStats } from '@/hooks/useMLPredictions';

describe('useMLPredictions', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useMLPredictions).toBeDefined();
            expect(useMLPrediction).toBeDefined();
            expect(useRecentMLPredictions).toBeDefined();
            expect(useExpiredPredictions).toBeDefined();
            expect(usePredictionStats).toBeDefined();
        });
    });
