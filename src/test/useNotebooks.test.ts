...
describe('useNotebooks', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useNotebooks).toBeDefined();
            expect(useSections).toBeDefined();
            expect(usePages).toBeDefined();
            expect(useAllPages).toBeDefined();
            expect(usePageLinks).toBeDefined();
        });
    });
