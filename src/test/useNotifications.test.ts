...
import { useNotifications, useUnreadCount, useMarkNotificationRead, useMarkAllNotificationsRead, useDeleteNotification, useCreateNotification, useNotificationsRealtime } from '@/hooks/useNotifications';
...
describe('useNotifications', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            ...
            expect(useMarkNotificationRead).toBeDefined();
            expect(useMarkAllNotificationsRead).toBeDefined();
            expect(useDeleteNotification).toBeDefined();
            expect(useCreateNotification).toBeDefined();
            expect(useNotificationsRealtime).toBeDefined();
        });
    });
