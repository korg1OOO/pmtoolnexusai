...
describe('usePortfolioBudget', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(usePortfolioBudget).toBeDefined();
        });
    });

    describe('usePortfolioBudget', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => usePortfolioBudget(), { wrapper: createWrapper() });
