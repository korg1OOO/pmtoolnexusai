...
import { usePortfolios, usePortfolio, useCreatePortfolio, useUpdatePortfolio, useDeletePortfolio } from '@/hooks/usePortfolios';

describe('usePortfolios', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(usePortfolios).toBeDefined();
            expect(usePortfolio).toBeDefined();
            expect(useCreatePortfolio).toBeDefined();
            expect(useUpdatePortfolio).toBeDefined();
            expect(useDeletePortfolio).toBeDefined();
        });
    });
