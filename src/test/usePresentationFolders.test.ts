/**
 * usePresentationFolders Hook Tests
 */
...
describe('usePresentationFolders', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(usePresentationFolders).toBeDefined();
        });
    });

    describe('usePresentationFolders', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => usePresentationFolders());
