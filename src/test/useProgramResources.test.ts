/**
 * useProgramResources Hook Tests
 */
...
describe('useProgramResources', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useProgramResources).toBeDefined();
        });
    });

    describe('useProgramResources', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useProgramResources(), { wrapper: createWrapper() });
