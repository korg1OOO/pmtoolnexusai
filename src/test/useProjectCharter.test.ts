...
import { useProjectCharter, useUpdateProjectCharter } from '@/hooks/useProjectCharter';

describe('useProjectCharter', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useProjectCharter).toBeDefined();
            expect(useUpdateProjectCharter).toBeDefined();
        });
    });

    describe('useProjectCharter', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useProjectCharter(), { wrapper: createWrapper() });
