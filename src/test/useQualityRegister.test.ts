...
import { useQualityRegister, useCreateQualityItem, useUpdateQualityItem, useDeleteQualityItem } from '@/hooks/useQualityRegister';

describe('useQualityRegister', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useQualityRegister).toBeDefined();
            expect(useCreateQualityItem).toBeDefined();
            expect(useUpdateQualityItem).toBeDefined();
            expect(useDeleteQualityItem).toBeDefined();
        });
    });

    describe('useQualityRegister', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useQualityRegister(), { wrapper: createWrapper() });
