...
import { useRequirements, useCreateRequirement, useUpdateRequirement, useDeleteRequirement, useBulkUpsertRequirements } from '@/hooks/useRequirements';

describe('useRequirements', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useRequirements).toBeDefined();
            expect(useCreateRequirement).toBeDefined();
            expect(useUpdateRequirement).toBeDefined();
            expect(useDeleteRequirement).toBeDefined();
            expect(useBulkUpsertRequirements).toBeDefined();
        });
    });

    describe('useRequirements', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useRequirements(), { wrapper: createWrapper() });
