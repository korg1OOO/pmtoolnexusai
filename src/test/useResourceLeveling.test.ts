/**
 * useResourceLeveling Hook Tests
 */
...
describe('useResourceLeveling', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useResourceLeveling).toBeDefined();
        });
    });

    describe('useResourceLeveling', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useResourceLeveling(), { wrapper: createWrapper() });
