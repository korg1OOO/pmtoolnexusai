...
describe('useScheduleTrigger', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useScheduleTrigger).toBeDefined();
        });
    });

    describe('useScheduleTrigger', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useScheduleTrigger(), { wrapper: createWrapper() });
