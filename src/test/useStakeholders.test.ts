...
import { useStakeholders, useCreateStakeholder, useUpdateStakeholder } from '@/hooks/useStakeholders';

describe('useStakeholders', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useStakeholders).toBeDefined();
            expect(useCreateStakeholder).toBeDefined();
            expect(useUpdateStakeholder).toBeDefined();
        });
    });

    describe('useStakeholders', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useStakeholders(), { wrapper: createWrapper() });
