/**
 * useSubscriptionAnalytics Hook Tests
 */
...
import { useSubscriptionAnalytics, useTierAnalytics, calculateChurnRate, calculateLTV, formatRevenue } from '@/hooks/useSubscriptionAnalytics';

describe('useSubscriptionAnalytics', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useSubscriptionAnalytics).toBeDefined();
            expect(useTierAnalytics).toBeDefined();
            expect(calculateChurnRate).toBeDefined();
            expect(calculateLTV).toBeDefined();
            expect(formatRevenue).toBeDefined();
        });
    });

    describe('useSubscriptionAnalytics', () => {
        it('can be rendered without crashing', () => {
            const { result } = renderHook(() => useSubscriptionAnalytics(), { wrapper: createWrapper() });
