...
import { useSubscriptions, useSubscriptionMetrics, useUpdateSubscription, useCancelSubscription, useMySubscription } from '@/hooks/useSubscriptions';
...
describe('useSubscriptions', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            ...
            expect(useMySubscription).toBeDefined();
        });
    });
