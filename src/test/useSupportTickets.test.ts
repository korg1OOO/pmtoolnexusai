...
import { useSupportTickets, useSupportTicket, useTicketReplies, useTicketAnalytics, useCreateTicket, useUpdateTicket, useAddTicketReply, useDeleteTicket } from '@/hooks/useSupportTickets';
