...
import { useSyncHistory, useLatestSync, useCreateSyncEntry, useUpdateSyncEntry, useTriggerSync } from '@/hooks/useSyncHistory';

describe('useSyncHistory', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useSyncHistory).toBeDefined();
            expect(useLatestSync).toBeDefined();
            expect(useCreateSyncEntry).toBeDefined();
            expect(useUpdateSyncEntry).toBeDefined();
            expect(useTriggerSync).toBeDefined();
        });
    });
