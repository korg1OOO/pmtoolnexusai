...
import { useTasks, useDependencies, useBaselines, useCreateTask, useUpdateTask, useBulkUpdateTasks, useDeleteTask, useCreateDependency, useDeleteDependency, useUpdateDependency, useCreateBaseline, useSaveProjectBaseline } from '@/hooks/useTasks';
...
describe('useTasks', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            ...
            expect(useBaselines).toBeDefined();
            expect(useCreateTask).toBeDefined();
            expect(useUpdateTask).toBeDefined();
            expect(useBulkUpdateTasks).toBeDefined();
            expect(useDeleteTask).toBeDefined();
            expect(useCreateDependency).toBeDefined();
            expect(useDeleteDependency).toBeDefined();
            expect(useUpdateDependency).toBeDefined();
            expect(useCreateBaseline).toBeDefined();
            expect(useSaveProjectBaseline).toBeDefined();
        });
    });
