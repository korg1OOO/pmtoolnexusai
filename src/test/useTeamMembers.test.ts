...
import { useTeamMembers, useAddTeamMember, useRemoveTeamMember, useUpdateTeamMemberRole } from '@/hooks/useTeamMembers';

describe('useTeamMembers', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useTeamMembers).toBeDefined();
            expect(useAddTeamMember).toBeDefined();
            expect(useRemoveTeamMember).toBeDefined();
            expect(useUpdateTeamMemberRole).toBeDefined();
        });
    });
