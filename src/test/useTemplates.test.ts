...
import { useTemplates, useTemplate, useCreateProjectFromTemplate } from '@/hooks/useTemplates';

describe('useTemplates', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useTemplates).toBeDefined();
            expect(useTemplate).toBeDefined();
            expect(useCreateProjectFromTemplate).toBeDefined();
        });
    });
