...
import { useSupportTickets, useSupportTicket, useTicketReplies, useCreateTicket, useUpdateTicket, useAddTicketReply, useAssignTicket, useResolveTicket, useCloseTicket } from '@/hooks/useTickets';

describe('useTickets', () => {
    describe('exports', () => {
        it('exports all expected items', () => {
            expect(useSupportTickets).toBeDefined();
            expect(useSupportTicket).toBeDefined();
            expect(useTicketReplies).toBeDefined();
            expect(useCreateTicket).toBeDefined();
            expect(useUpdateTicket).toBeDefined();
            expect(useAddTicketReply).toBeDefined();
            expect(useAssignTicket).toBeDefined();
            expect(useResolveTicket).toBeDefined();
            expect(useCloseTicket).toBeDefined();
        });
    });
